...
#include "../../homework/menubar/editmenu.h"
...
QT_MOC_LITERAL(1, 9, 12), // "cutRequested"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 13), // "copyRequested"
QT_MOC_LITERAL(4, 37, 14) // "pasteRequested"

    },
    "EditMenu\0cutRequested\0\0copyRequested\0"
    "pasteRequested"
};
...
void EditMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (EditMenu::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&EditMenu::cutRequested)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (EditMenu::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&EditMenu::copyRequested)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (EditMenu::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&EditMenu::pasteRequested)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject EditMenu::staticMetaObject = {
    { &QMenu::staticMetaObject, qt_meta_stringdata_EditMenu.data,
      qt_meta_data_EditMenu,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void EditMenu::cutRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void EditMenu::copyRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 1, Q_NULLPTR);
}

// SIGNAL 2
void EditMenu::pasteRequested()
{
